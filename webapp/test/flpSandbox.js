		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Gst Reconcilitation",
									"targetURL": "#zgstreconzgstrecon-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zgstreconzgstrecon-display": {
								"semanticObject": "zgstreconzgstrecon",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zgstrecon.zgstrecon",
									"url": sap.ui.require.toUrl("zgstrecon/zgstrecon")
								}
							}
						}
					}
